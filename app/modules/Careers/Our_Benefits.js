...
<div className="max-w-6xl w-full md:text-left ">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-10 bg-[url(/images/Back.svg)] bg-no-repeat  bg-cover rounded-lg p-6">
          ...
          {benefitsData.map((item) => (
            <div
              key={item.id}
              className="p-5 md:p-6 rounded-2xl shadow-lg flex flex-col text-left"
            >
